...
return (function (){
if(cljs.core.truth_((function (){var and__17941__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__32420 = script;
(G__32420["type"] = "text/javascript");

(G__32420["onload"] = onload);

(G__32420["onreadystatechange"] = onload);

return G__32420;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__32421 = script__$1;
(G__32421["src"] = src);

return G__32421;
})():(function (){var G__32422 = script__$1;
goog.dom.setTextContext(G__32422,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__17953__auto__ = reload;
...
var path_32423 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_32423];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_32423)].join('')];
} else {
}
